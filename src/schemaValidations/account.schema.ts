...
export const ChangePasswordBody = z
  .object({
    oldPassword: z
      .string()
      .min(6, { message: "Mật khẩu cũ cần chứa ít nhất 6 ký tự" })
      .max(100, { message: "Mật khẩu cũ không được vượt quá 100 ký tự" }),
    password: z
      .string()
      .min(6, { message: "Mật khẩu mới cần chứa ít nhất 6 ký tự" })
      .max(100, { message: "Mật khẩu mới không được vượt quá 100 ký tự" }),
    confirmPassword: z
      .string()
      .min(6, { message: "Xác nhận mật khẩu cần chứa ít nhất 6 ký tự" })
